...
public class Login : MonoBehaviour
{
    ...
    public void OnClickLogin()
    {
        ...
        mode = 0;
        Splash.client_username = "proninkirilll228@gmail.com";
        string username = Splash.client_username;
        string password = Splash.client_username;
        ...
        string requestURL = Global.currentDomain + "/v1/users/login_game";
