...
namespace Assets.Project.Chess3D
{
    public class Spawner: MonoBehaviour
    {
        ...
        public static int taken_piece = 0;
        public static char piece_label = '\0';
        ...
        public void DestroyPiece(Piece piece)
        {
            try
            {
                ...
                //     DesFxObj.gameObject.SetActive(true);
        ...
        //     DesFxObjs = GameObject.FindGameObjectsWithTag("Effects");
        //     foreach(GameObject DesFxObj in DesFxObjs)
        //         DesFxObj.gameObject.SetActive(false);
        //     Debug.Log("1231111111111111111111111111111111");
